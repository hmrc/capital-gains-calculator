...
/** Copyright 2024 HM Revenue & Customs
  ...
  * an "AS IS" BASIS, WITHOUT WARRANTIED OR CONDITIONS OF ANY KIND, either express or implied. See the License for the
...
case class PropertyChargeableGainModel(
...
object PropertyChargeableGainModel extends ResidentPropertyBinders
