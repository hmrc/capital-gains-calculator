...
class ResidentPropertyBindersSpec extends PlaySpec with MockitoSugar {
  ...
  "Calling Property Total Gain binder " when {
    ...
    "calling .unBind" must {
      ...
      "return a valid queryString on unbind with different values" in {
        val totalGainString =
          "disposalValue=2000.0&disposalCosts=1500.0&acquisitionValue=1750.0&acquisitionCosts=3000.0"
  ...
  "Calling Property Chargeable Gain binder " when {
    ...
    "calling .unBind" must {
      ...
      "return a valid queryString on unbind with identical values" in {
        ...
        val date                        = LocalDate.parse("2016-10-10")
        val propertyChargeableGainModel = new PropertyChargeableGainModel(
          propertyTotalGainModel,
          Some(2000.0),
          Some(2000.0),
          Some(2000.0),
        ...
        val propertyTotalGainString =
          "disposalValue=2000.0&disposalCosts=2000.0&acquisitionValue=2000.0&acquisitionCosts=2000.0&improvements=2000.0"
      ...
      "return a valid queryString on unbind with different values" in {
        ...
        val propertyTotalGainString =
          "disposalValue=2000.0&disposalCosts=1500.0&acquisitionValue=1750.0&acquisitionCosts=3000.0&improvements=2500.0"
        val result                  = binder.unbind("", propertyChargeableGainModel)
  ...
  "Calling Property Calculate Tax Owed binder" when {
    ...
    "given a valid binding value where all values are the same" must {
      ...
      val date                          = LocalDate.parse("2016-10-10")
      val propertyChargeableGainModel   = PropertyChargeableGainModel(
        propertyTotalGainModel,
        Some(1000.0),
        Some(1000.0),
        Some(1000.0),
      ...
      val propertyChargeableGainRequest =
        "disposalValue=1000.0&disposalCosts=1000.0&acquisitionValue=1000.0&acquisitionCosts=1000.0&improvements=1000.0" +
      ...
      "return a valid PropertyCalculateTaxOwedModel on bind" in {
        ...
        result mustBe Some(
          Right(PropertyCalculateTaxOwedModel(propertyChargeableGainModel, Some(1000.0), 1000.0, 1000.0))
        )
      }

      "return a valid queryString on unbind" in {
        val result =
          binder.unbind("key", PropertyCalculateTaxOwedModel(propertyChargeableGainModel, Some(1000.0), 1000.0, 1000.0))
    ...
    "given a valid binding value where all values are different" must {
      ...
      val propertyChargeableGainRequest =
        "disposalValue=2000.0&disposalCosts=2500.0&acquisitionValue=3000.0&acquisitionCosts=3500.0&improvements=6000.0" +
      ...
      "return a valid queryString on unbind" in {
        val result =
          binder.unbind("key", PropertyCalculateTaxOwedModel(propertyChargeableGainModel, Some(4500.0), 5000.0, 5500.0))
