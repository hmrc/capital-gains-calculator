  ...
  "Calling validateNonResidentProperty with an invalid model" must {
    ...
    "When the first error is the priorDisposal" in {
      NonResidentValidation.validateNonResidentProperty(CalculationRequestModel(
        ...
        DateTime.parse("2016-12-12"), Some("suihur"), Some(10231289.129312))) mustBe Left("priorDisposal must be either Yes or No")
    }
    ...
    "When the first error is the annualExemptAmount" in {
      NonResidentValidation.validateNonResidentProperty(CalculationRequestModel(
        ...
        -200000.0, 800.01234123, 1000000000000000.0, -200.0, 12000.0813, 0.2138924, 0.123893, Some(DateTime.parse("2016-12-24")),
        DateTime.parse("2016-12-12"), Some("suihur"), Some(10231289.129312))) mustBe Left("annualExemptAmount cannot be negative.")
    }
    ...
    "When the first error is the otherPropertiesAmount" in {
      NonResidentValidation.validateNonResidentProperty(CalculationRequestModel(
        "Yes", Some(1239.00), Some(1.00123), 9123182324127123.0, Some(-12314.0),
        -200000.0, 800.01234123, 1000000000000000.0, -200.0, 12000.0813, 0.2138924, 0.123893, Some(DateTime.parse("2016-12-24")),
        DateTime.parse("2016-12-12"), Some("suihur"), Some(10231289.129312))) mustBe Left("otherPropertiesAmt has too many decimal places.")
    }
    ...
    "When the first error is the currentIncome" in {
      NonResidentValidation.validateNonResidentProperty(CalculationRequestModel(
        ...
        -200000.0, 800.01234123, 1000000000000000.0, -200.0, 12000.0813, 0.2138924, 0.123893, Some(DateTime.parse("2016-12-24")),
        DateTime.parse("2016-12-12"), Some("suihur"), Some(10231289.129312))) mustBe Left("currentIncome cannot be larger than 1,000,000,000.")
    }
    ...
    "When the first error is the personalAllowanceAmount" in {
      NonResidentValidation.validateNonResidentProperty(CalculationRequestModel(
        ...
        -200000.0, 800.01234123, 1000000000000000.0, -200.0, 12000.0813, 0.2138924, 0.123893, Some(DateTime.parse("2016-12-24")),
        DateTime.parse("2016-12-12"), Some("suihur"), Some(10231289.129312))) mustBe Left("personalAllowanceAmt cannot be negative.")
    }
    ...
    "When the first error is the disposalValue" in {
      NonResidentValidation.validateNonResidentProperty(CalculationRequestModel(
        ...
        -200000.0, 800.01234123, 1000000000000000.0, -200.0, 12000.0813, 0.2138924, 0.123893, Some(DateTime.parse("2016-12-24")),
        DateTime.parse("2016-12-12"), Some("suihur"), Some(10231289.129312))) mustBe Left("disposalValue cannot be negative.")
    }
    ...
    "When the first error is the disposalCosts" in {
      NonResidentValidation.validateNonResidentProperty(CalculationRequestModel(
        "Yes", Some(1239.00), Some(1.00), 5000.0, Some(1000.0),
        200000.0, 800.01234123, 1000000000000000.0, -200.0, 12000.0813, 0.2138924, 0.123893, Some(DateTime.parse("2016-12-24")),
        DateTime.parse("2016-12-12"), Some("suihur"), Some(10231289.129312))) mustBe Left("disposalCosts has too many decimal places.")
    }
    ...
    "When the first error is the initialValue" in {
      NonResidentValidation.validateNonResidentProperty(CalculationRequestModel(
        ...
        DateTime.parse("2016-12-12"), Some("suihur"), Some(10231289.129312))) mustBe Left("initialValueAmt cannot be larger than 1,000,000,000.")
    }
    ...
    "When the first error is the initialCosts" in {
      NonResidentValidation.validateNonResidentProperty(CalculationRequestModel(
        ...
        DateTime.parse("2016-12-12"), Some("suihur"), Some(10231289.129312))) mustBe Left("initialCostsAmt cannot be negative.")
    }
    ...
    "When the first error is the improvementsAmount" in {
      NonResidentValidation.validateNonResidentProperty(CalculationRequestModel(
        "Yes", Some(1239.00), Some(1.00), 5000.0, Some(1000.0),
        200000.0, 800.0, 100000.0, 200.0, 12000.0813, 0.2138924, 0.123893, Some(DateTime.parse("2016-12-24")),
        DateTime.parse("2016-12-12"), Some("suihur"), Some(10231289.129312))) mustBe Left("improvementsAmt has too many decimal places.")
    }
    ...
    "When the first error is the reliefsAmount" in {
      NonResidentValidation.validateNonResidentProperty(CalculationRequestModel(
        ...
        DateTime.parse("2016-12-12"), Some("suihur"), Some(10231289.129312))) mustBe Left("reliefs has too many decimal places.")
    }
    ...
    "When the first error is the allowableLosses" in {
      NonResidentValidation.validateNonResidentProperty(CalculationRequestModel(
        ...
        DateTime.parse("2016-12-12"), Some("suihur"), Some(10231289.129312))) mustBe Left("allowableLossesAmt has too many decimal places.")
    }
    ...
    "When the first error is the acquisitionDate" in {
      NonResidentValidation.validateNonResidentProperty(CalculationRequestModel(
        ...
        DateTime.parse("2016-12-12"), Some("suihur"), Some(10231289.129312))) mustBe Left("The acquisitionDate must be before the disposalDate")
    }
    ...
    "When the first error is the disposalDate" in {
      NonResidentValidation.validateNonResidentProperty(CalculationRequestModel(
        ...
        DateTime.parse("2014-12-12"), Some("suihur"), Some(10231289.129312))) mustBe Left("disposalDate cannot be before 2015-04-06")
    }
    ...
    "When the first error is the isClaimingPRR" in {
      NonResidentValidation.validateNonResidentProperty(CalculationRequestModel(
        "Yes", Some(1239.00), Some(1.00), 5000.0, Some(1000.0),
        200000.0, 800.0, 100000.0, 200.0, 12000.0, 0.2, 1000.0, Some(DateTime.parse("2010-12-24")),
        DateTime.parse("2016-12-12"), Some("suihur"), Some(10231289.129312))) mustBe Left("isClaimingPRR must be either Yes or No")
    }
    ...
    "When the first error is the daysClaimed" in {
      NonResidentValidation.validateNonResidentProperty(CalculationRequestModel(
        "Yes", Some(1239.00), Some(1.00), 5000.0, Some(1000.0),
        200000.0, 800.0, 100000.0, 200.0, 12000.0, 0.2, 1000.0, Some(DateTime.parse("2010-12-24")),
        DateTime.parse("2016-12-12"), Some("Yes"), Some(10231289.129))) mustBe Left("daysClaimed has too many decimal places.")
    }
  }
